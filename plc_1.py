# NOTE:
# This code is a replica of the original project I worked on during my internship at TDK.
# The original code, along with the air pressure sensor device, was provided by TDK due to their privacy and security policies.
# I was not allowed to use my personal device/laptop for the project.
# As I do not have access to the original code or the sensor, this version generates random real-time air pressure values using the Python 'random' library.
